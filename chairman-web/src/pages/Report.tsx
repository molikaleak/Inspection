        ...
        <header className="apple-card p-6 border-l-[3px] border-primary">
           <div className="flex items-start justify-between gap-6">
             <div className="flex-1">
                <p className="text-[12px] text-primary font-medium mb-1.5">Inspection Report</p>
                <h1 className="text-[24px] font-semibold tracking-tight text-on-surface leading-tight mb-4">{report.subject}</h1>
